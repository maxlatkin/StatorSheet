...
public class Screw07 implements Screw {
	...
	public void build(Solid currSolid) {
		try {
			...
			FetOperations.deleteFeature(currSolid, "SCREW_01_SOLID_2", "SCREW_01_HOLE_2",
					...
					"SCREW_04_HOLE", "SCREW_05_HOLE", "SCREW_06_HOLE");
			LOG.info("Screw_07_Qty={} is built", DataStore.getScrew05Qty());
		} catch (jxthrowable e) {
			LOG.error("Error creating the Screw_07 - {}", e);
		}
	}
}
